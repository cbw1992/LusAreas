...
<head>
    ...
    <link rel="shortcut icon" href="/static/mobilcepu_icon.ico" type="image/x-icon" />
    <link rel="icon" href="/static/mobilcepu_icon.ico" type="image/x-icon" />
    ...
    <style>
	    ...
	    .login-bg {
	        background: #007dba url('/static/img/login_bg1.jpg') no-repeat center top;
			            ...
			            <div class="form form-horizontal fh" data-bind="visible:Mode()==''">
			                ...
			                <div class="form-group">
			                    <div class="col-sm-12 login-footer">
			                        ...
			                        <span>
			                            Licensed for demo App - Valid throught 31 Jan 2016
			                        </span>
			                    </div>
			                </div>
